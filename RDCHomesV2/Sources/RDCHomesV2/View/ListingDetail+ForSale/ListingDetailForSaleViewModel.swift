...
final class ListingDetailForSaleViewModel: SingleViewModel<ListingDetail.ForSale> {
    
    public init(listingModel: DetailListingModel, resolver: IHomesV2Resolver) {
        
        super.init {
            ListingDetail.ForSale(
                ...
                neighborhood: .viewObserving(stream: NeighborhoodViewModel(forListingId: listingModel.id, resolver: resolver)),
